...
public class StartingClass extends Applet implements Runnable, KeyListener {
    ...
    public void init() {
        ...
        try {
            // define URL base
            charBase = this.getClass().getResource("/main/data/character.png");
            charBase2 = this.getClass().getResource("/main/data/character2.png");
            charBase3 = this.getClass().getResource("/main/data/character3.png");
            charBase4 = this.getClass().getResource("/main/data/character4.png");

            charBase5 = this.getClass().getResource("/main/data/leftcharacter.png");
            charBase6 = this.getClass().getResource("/main/data/leftcharacter2.png");
            charBase7 = this.getClass().getResource("/main/data/leftcharacter3.png");
            charBase8 = this.getClass().getResource("/main/data/leftcharacter4.png");

            charJumpedBase = this.getClass().getResource("/main/data/character3.png");
            charJumpedLeftBase = this.getClass().getResource("/main/data/leftcharacter3.png");

            sushiBase = this.getClass().getResource("/main/data/sushi.png");
            milkBase = this.getClass().getResource("/main/data/milk.png");
            heartBase = this.getClass().getResource("/main/data/heart.gif");

            bgBase = this.getClass().getResource("/main/data/background.png");
        } catch (Exception e) {
